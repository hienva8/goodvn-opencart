...
--
-- Host: localhost
-- Generation Time: Apr 11, 2012 at 08:53 PM
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.62849998, 1, '2012-04-09 19:03:12'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2012-04-11 19:24:13'),
(3, 'Euro', 'EUR', '', '€', '2', 0.76179999, 1, '2012-04-09 19:03:12');
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=24624 ;
...
(24620, 0, 'config', 'config_google_analytics', '', 0),
(24619, 0, 'config', 'config_error_filename', 0x6572726f722e747874, 0),
(24618, 0, 'config', 'config_error_log', 0x31, 0),
(24617, 0, 'config', 'config_error_display', 0x31, 0),
(24616, 0, 'config', 'config_compression', 0x30, 0),
(24615, 0, 'config', 'config_encryption', 0x3132333435, 0),
(24621, 0, 'featured', 'product', '', 0),
(24622, 0, 'featured', 'featured_product', 0x34312c34302c34382c33362c33342c3332, 0),
(24614, 0, 'config', 'config_maintenance', 0x30, 0),
(24613, 0, 'config', 'config_seo_url', 0x31, 0),
(24612, 0, 'config', 'config_use_ssl', 0x30, 0),
(24611, 0, 'config', 'config_alert_emails', '', 0),
(24610, 0, 'config', 'config_account_mail', 0x30, 0),
(24609, 0, 'config', 'config_alert_mail', 0x30, 0),
(24608, 0, 'config', 'config_smtp_timeout', 0x35, 0),
(24607, 0, 'config', 'config_smtp_port', 0x3235, 0),
(24606, 0, 'config', 'config_smtp_password', '', 0),
(24605, 0, 'config', 'config_smtp_username', '', 0),
(24604, 0, 'config', 'config_smtp_host', '', 0),
(24603, 0, 'config', 'config_mail_parameter', '', 0),
(24602, 0, 'config', 'config_mail_protocol', 0x6d61696c, 0),
...
(24601, 0, 'config', 'config_image_cart_height', 0x3830, 0),
(24600, 0, 'config', 'config_image_cart_width', 0x3830, 0),
...
(24599, 0, 'config', 'config_image_wishlist_height', 0x3530, 0),
(24598, 0, 'config', 'config_image_wishlist_width', 0x3530, 0),
(24597, 0, 'config', 'config_image_compare_height', 0x3930, 0),
(24596, 0, 'config', 'config_image_compare_width', 0x3930, 0),
(24595, 0, 'config', 'config_image_related_height', 0x3830, 0),
(24594, 0, 'config', 'config_image_related_width', 0x3830, 0),
(24591, 0, 'config', 'config_image_product_height', 0x3830, 0),
(24592, 0, 'config', 'config_image_additional_width', 0x3734, 0),
(24593, 0, 'config', 'config_image_additional_height', 0x3734, 0),
(24590, 0, 'config', 'config_image_product_width', 0x3830, 0),
(24587, 0, 'config', 'config_image_thumb_height', 0x323238, 0),
(24589, 0, 'config', 'config_image_popup_height', 0x353030, 0),
(24588, 0, 'config', 'config_image_popup_width', 0x353030, 0),
(24586, 0, 'config', 'config_image_thumb_width', 0x323238, 0),
(24585, 0, 'config', 'config_image_category_height', 0x3830, 0),
(24584, 0, 'config', 'config_image_category_width', 0x3830, 0),
(24583, 0, 'config', 'config_icon', 0x646174612f476f6f6473766e2f7474747474742e706e67, 0),
(24582, 0, 'config', 'config_logo', 0x646174612f476f6f6473766e2f6c6f676f2e706e67, 0),
(24580, 0, 'config', 'config_upload_allowed', 0x6a70672c204a50472c206a7065672c206769662c20706e672c20747874, 0),
(24581, 0, 'config', 'config_cart_weight', 0x30, 0),
(24579, 0, 'config', 'config_download', 0x30, 0),
(24578, 0, 'config', 'config_review_status', 0x30, 0),
(24577, 0, 'config', 'config_return_status_id', 0x32, 0),
(24576, 0, 'config', 'config_complete_status_id', 0x35, 0),
(24575, 0, 'config', 'config_order_status_id', 0x31, 0),
(24574, 0, 'config', 'config_stock_status_id', 0x35, 0),
(24572, 0, 'config', 'config_stock_warning', 0x30, 0),
(24573, 0, 'config', 'config_stock_checkout', 0x30, 0),
(24571, 0, 'config', 'config_stock_display', 0x30, 0),
(24570, 0, 'config', 'config_commission', 0x35, 0),
(24569, 0, 'config', 'config_affiliate_id', 0x34, 0),
(24568, 0, 'config', 'config_checkout_id', 0x35, 0),
(24567, 0, 'config', 'config_account_id', 0x33, 0),
(24566, 0, 'config', 'config_guest_checkout', 0x31, 0),
(24565, 0, 'config', 'config_customer_approval', 0x30, 0),
(24564, 0, 'config', 'config_customer_price', 0x30, 0),
(24563, 0, 'config', 'config_customer_group_id', 0x38, 0),
(24562, 0, 'config', 'config_invoice_prefix', 0x494e562d323031312d3030, 0),
(24561, 0, 'config', 'config_tax_customer', '', 0),
(24560, 0, 'config', 'config_tax_default', '', 0),
(24559, 0, 'config', 'config_tax', 0x30, 0),
(24558, 0, 'config', 'config_admin_limit', 0x3230, 0),
(24557, 0, 'config', 'config_catalog_limit', 0x3135, 0),
(24556, 0, 'config', 'config_weight_class_id', 0x31, 0),
(24555, 0, 'config', 'config_length_class_id', 0x31, 0),
(24554, 0, 'config', 'config_currency_auto', 0x31, 0),
(24553, 0, 'config', 'config_currency', 0x555344, 0),
(24551, 0, 'config', 'config_language', 0x656e, 0),
(24552, 0, 'config', 'config_admin_language', 0x656e, 0),
(24550, 0, 'config', 'config_zone_id', 0x33373830, 0),
(24549, 0, 'config', 'config_country_id', 0x323330, 0),
(24548, 0, 'config', 'config_layout_id', 0x34, 0),
(24547, 0, 'config', 'config_template', 0x64656661756c74, 0),
(24546, 0, 'config', 'config_meta_description', 0x476f6f6473564e, 0),
(24545, 0, 'config', 'config_title', 0x476f6f6473564e, 0),
(24544, 0, 'config', 'config_fax', '', 0),
(24543, 0, 'config', 'config_telephone', 0x313233343536373839, 0),
(24542, 0, 'config', 'config_email', 0x61646d696e4061646d696e2e636f6d, 0),
(24541, 0, 'config', 'config_address', 0x416464726573732031, 0),
(24540, 0, 'config', 'config_owner', 0x476f6f6473564e, 0),
(24539, 0, 'config', 'config_name', 0x476f6f6473564e, 0);
